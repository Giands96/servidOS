...
public class CrearEmpleadoUseCase {
    ...
    * */
    @Transactional
    public Usuario ejecutar(CrearEmpleadoCommand command) {
    ...
    @Transactional
    public Usuario ejecutar(CrearEmpleadoCommand command, Long restauranteIdIgnorado) {
        return ejecutar(command);
    }

    private void validar(CrearEmpleadoCommand cmd, Long restauranteId) {
        if (cmd == null) {
